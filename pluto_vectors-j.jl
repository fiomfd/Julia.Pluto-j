...
# ╔═╡ 6582f128-8469-4a55-941a-c1b908024497
...
a1 = $(@bind a1 Slider(-1.5:0.1:1.5, show_value=true, default=1))  
b1 = $(@bind b1 Slider(-1.5:0.1:1.5, show_value=true, default=-1))  

a2 = $(@bind a2 Slider(-1.5:0.1:1.5, show_value=true, default=0.5))  
b2 = $(@bind b2 Slider(-1.5:0.1:1.5, show_value=true, default=0.5))  
"""
...
begin
    ...
    A1 = [0, a1]; A2 = [0, a2]
    B1 = [0, b1]; B2 = [0, b2]
    AB1 = [0, a1+b1]; AB2 = [0, a2+b2]
    C1 = [a1, a1+b1, NaN, b1, a1+b1]
    C2 = [a2, a2+b2, NaN, b2, a2+b2]
    ...
    annotate!([
        (a1, a2, text(L"\vec{a}", :blue, 10)),
        (b1, b2, text(L"\vec{b}", :orange, 10)),
        (a1+b1, a2+b2, text(L"\vec{a}+\vec{b}", :green, 10))
    ])
end
...
manifest_format = "2.0"
project_hash = "3df9113f80fa4f59a63f036fe7a0333373a8a894"
